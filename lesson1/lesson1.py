...
def dict_quiz():
    ...
    intel_chip['baby_lake'] = intel_chip.pop(
        'kaby_lake'
    )  # 這一行等同於上面三行，並且不用有多的變數以及新的baby_lake取代kaby_lake，他的值也是跟kaby_lake一樣是0，參考https://blog.csdn.net/a1007720052/article/details/81542134
